...
nnoremap \ap :ALEPreviousWrap
nnoremap \an :ALENextWrap
nmap ]C 9999]c
...
nnoremap <silent> gh :call CocAction('doHover')
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-javascript,~/.vim/plugged/vim-jsx-pretty,~/.vim/plugged/yats.vim,~/.vim/plugged/vim-signify,~/.vim/plugged/vim-snippets,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-commentary,~/.vim/plugged/vim-devicons,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-nerdtree-syntax-highlight,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/vim-jsx-pretty/after,~/.vim/plugged/vim-nerdtree-syntax-highlight/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set scrolloff=10
set shiftwidth=2
